...
-- Helpers from elenapan/dotfiles
...
--            {description = "activate window switcher", group = "client"}),
    ...
    awful.key({modkey}, "minus",
        function()
            ...
            {description = "decrement gaps size for the current tag", group = "gaps"}),
    ...
    awful.key({ modkey, altkey   }, "r",     function () awful.tag.incnmaster(-1, nil, true)        end,
...
--              {description = "decrease the number of columns", group = "layout"}),
    ...
    awful.key({ modkey,           }, "b", function () awful.spawn(filemanager)            end,
...
-- Turn off gigantic Spotify notifcations
