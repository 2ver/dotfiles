;; lena-theme.el -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
(defgroup lena-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom lena-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'lena-theme
  :type 'boolean)

(defcustom lena-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'lena-theme
  :type 'boolean)

(defcustom lena-comment-bg lena-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'lena-theme
  :type 'boolean)

(defcustom lena-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme lena
  ...
  ((bg         `(,xrbg nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if lena-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if lena-brighter-comments dark-cyan base5) 0.25))
   (constants      violet)
   (functions      magenta)
   (keywords       blue)
   (methods        cyan)
   ...
   (-modeline-bright lena-brighter-modeline)
   (-modeline-pad
    (when lena-padded-modeline
      (if (integerp lena-padded-modeline) lena-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if lena-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
